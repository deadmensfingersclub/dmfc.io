  ...
  system: () => `
    ...
    <div class="species-grid">
      ...
      <div class="species-card">
        ...
        <div class="species-ref">캐릭터가 소지하고 있지 않은 물건 습득 방법의 예시 : 나는 자판기에 권총을 넣고 싶었다. 스파이시 불릿이 필요한 누군가가 있을 거라고 생각했기 때문이다. 그러나 나에게는 권총이 없기 때문에, 유라이어의 더미로 찾아가 주인장의 권총을 몰래 훔쳤다. 기다려라, 네버모어. 나의 스파이시 불릿이 간다…)</div>
      </div>
      <div class="species-card">
